...
class TicketService {
  ...
  async createTicket(values) {
    ...
    let payload = {"title":values.title,"description":values.description,"severity":values.severity,"status":values.status,"createdUser":values.createdUser,"projectId":values.projectId};
    //console.log(payload);
