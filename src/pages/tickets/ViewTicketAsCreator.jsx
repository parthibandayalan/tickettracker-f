...
export default function ViewTicketAsCreator(props) {
  ...
  useEffect(() => {
    ...
    //console.log(ticket.assignedUser.id);
  }, [ticketId]);
          ...
          <TableContainer component={Paper} className={classes.table}>
            <Table aria-label="simple table">
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell align="right">
                    <EditComponent
                      passedValue={ticket.description}
                      passedColumn="description"
                      passedId={ticket.id}
                    />
                  </TableCell>
                </TableRow>
              ...
              <TableCell align="right">
                <EditDropDownComponent
                  // passedValue={
                  //   ticket.assignedUser != null ? ticket.assignedUser.id : ""
                  // }
                  passedValue={ticket.assignedUser.id}
                  items={contributors}
                  passedColumn="assignedUser"
                  passedId={ticket.id}
                  // passedLabel={
                  ...
                  //     : ""
                  // }
                  passedLabel={ticket.assignedUser.fullname}
                />
              </TableCell>
            </TableRow> */}
                <TableRow>
